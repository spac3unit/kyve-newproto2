...
import (
	v0_6_4 "github.com/KYVENetwork/chain/app/upgrades/v0.6.4"
	"io"
	"net/http"
	"os"
	"path/filepath"
...
func (app *App) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(v0_6_4.UpgradeName, v0_6_4.CreateUpgradeHandler(&app.RegistryKeeper))
}
